                ...
                $statement -> execute();
                    while($row = $statement->fetch()) {
                        ...
                        echo "<td>".'<form action="/action_page.php">'.
                            '<input class="form-check-input" type="radio" name="valider" value="Valider"> Valider'.'<br>'.
                            '<input class="form-check-input" type="radio" name="refuser" value="Refuser"> Refuser'.'<br>'.
